...
<style>
    ...
    .hero {{
        background: linear-gradient(120deg, {COLOR_PRIMARIO} 0%, {COLOR_ACENTO} 100%);
        border-radius: 16px; padding: 26px 30px; margin-bottom: 18px;
        color: white; box-shadow: 0 6px 18px rgba(15,110,86,0.18);
    }}
    .hero h1 {{ font-size: 30px; font-weight: 700; margin: 0; color: white; }}
    .hero p  {{ font-size: 15px; margin: 6px 0 0 0; color: #E6F4EC; }}
    .hero .autoria {{ font-size: 13px; margin-top: 12px; color: #D6ECDD; opacity: .95; }}
 
    /* Pestañas */
    .stTabs [data-baseweb="tab-list"] {{
        gap: 4px; background-color: #E4EFE4; padding: 5px; border-radius: 12px;
    }}
    .stTabs [data-baseweb="tab"] {{
        border-radius: 9px; padding: 9px 22px; color: {COLOR_PRIMARIO}; font-weight: 500;
    }}
...
<div class="hero">
    ...
    <p>California · idoneidad agrícola en el presente y bajo escenarios de cambio climático</p>
    <div class="autoria">Trabajo de Fin de Máster · Ciencia de Datos &nbsp;|&nbsp;
        Autora: <b>Leslie Estefany Mosquera</b> &nbsp;·&nbsp;
        Tutor: <b>José Lloreda Sánchez</b> &nbsp;·&nbsp;
        La Salle – Universitat Ramon Llull</div>
</div>
""", unsafe_allow_html=True)
 
tab1, tab2, tab3, tab4 = st.tabs(
    ["📍 Mi lote", "🗺️ Mapas por cultivo", "✏️ Datos manuales", "ℹ️ Acerca de"])
