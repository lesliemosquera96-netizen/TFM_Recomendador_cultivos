...
for ab, (tlat, tlon) in externos.items():
    ...
    fig.add_trace(go.Scattergeo(
        ...
        mode="text",
        textfont=dict(size=15, color="#0b3d0b", family="Arial"),
        showlegend=False, hoverinfo="skip",
    ))
...
fig.update_layout(
    title=dict(
        text="<b>Producción agrícola de EE.UU. por estado (2024)</b>"
             "<br><sup>Total nacional: $573B — escala de verdes: más verde = mayor producción</sup>",
...
# Fuentes grandes también en la barra de color
